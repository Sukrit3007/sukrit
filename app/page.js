...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-between p-6 md:px-24 pt-24 m-auto h-screen ">
            <div className="grid gap-8 xl:grid-cols-6 xl:grid-rows-10 w-[100%] lg:w-[80%] h-full rounded-2xl lg:overflow-hidden ">
                ...
                <div className="lg:col-span-2 xl:row-span-9 order-1 xl:order-none xl:overflow-auto rounded-2xl ">
                    <MainCard/>
                </div>
